...
<body>
<a href="media.php?page=pertanyaan&aksi=add">Tambah</a>
...
<form method="post" action="insert_gejala.php">
  ...
  <td width="50" align="center"><input type="button" value=" Batal " onclick="parent.location='media.php?page=pertanyaan'" /></td>
</form>
</tr>
<?php
}
